module Events
  module Invitations
    class Created
      ...
      EVENT_NAME    = "created.invitiation".freeze
      EVENT_VERSION = "0.1".freeze

      attr_accessor :teammate

      def initialize(teammate:, user:)
        @teammate = teammate # is a User
        @user     = user
      end
      ...
      def payload
        {
          ...
          source: {
            ...
            name: EVENT_NAME,
            ts_ms: (@teammate.created_at.to_f * 1000).to_i,
            table: @teammate.class.table_name
          },
          op: 'c',
